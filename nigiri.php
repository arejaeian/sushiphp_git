...
.container .card {position:relative;min-width:820px;height:1240px;box-shadow:inset 5px 5px 5px rgba(0,0,0,0.2),inset -5px -5px 15px rgba(255,255,255,0.1),inset 5px 5px 5px rgba(0,0,0,0.3),inset -5px -5px 15px rgba(255,255,255,0.1);border-radius:15px;margin:30px;}
...
<body>
	...
	<div class="card">
	<div class="bbox">
	<div class="content2"><img src="img/nig.jpg" class="r1"><h3>Nigiri Sushi</h3><p>Zutaten:<br>vorgekochter Sushi-Reis aus 150 g Sushi-Reis (Trockengewicht)<br>Wasabi<br>100 g  rohes Lachsfilet (Sushi-Qualität)</p>
	<p>Zubereitung in 15 Minuten<br>Hände mit Wasser befeuchten und aus dem Reis 12 ovale Röllchen (à ca. 25 g) formen. Mit wenig Wasabi bestreichen. Lachs in 12 dünne Scheiben schneiden und darauflegen.</p>
